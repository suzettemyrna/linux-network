...
![Результат работы ipcalc](../../images/Part1/1.1.png)
...
- Маска `/15`:
  ...
  ![Маска /15 в обычную и двоичную запись](../../images/Part1/1.2.2.png)
...
- Маска `11111111.11111111.11111111.11110000`:
  ...
  ![Маска 11111111.11111111.11111111.11110000 в обычную и префиксную запись](../../images/Part1/1.2.3.png)
...
- Преобразуем маску `255.255.255.0`:
  ...
  ![Маска 255.255.255.0 в префиксную и двоичную запись](../../images/Part1/1.2.1.png)
...
![Минимальный и максимальный адрес хоста](../../images/Part1/1.3.png)
...
![Публичные и частные IP](../../images/Part1/3.1.png)
...
![Диапазон адресов сети](../../images/Part1/3.2.png)
